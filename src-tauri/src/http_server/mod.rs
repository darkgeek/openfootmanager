...
pub async fn start_server(port: u16) -> Result<(), Box<dyn std::error::Error>> {
    ...
    let app = Router::new()
        ...
        .route("/api/set_player_squad_role", post(set_player_squad_role))

        // Finance
        .route("/api/get_finance_snapshot", post(get_finance_snapshot))
        .route("/api/request_board_support", post(request_board_support))
        .route("/api/request_sponsor_pitch", post(request_sponsor_pitch))
        .route("/api/request_marketing_campaign", post(request_marketing_campaign))
        ...
        .route("/api/offer_free_agent_contract", post(offer_free_agent_contract))
        .route("/api/preview_free_agent_contract_impact", post(preview_free_agent_contract_impact))
        .route("/api/set_contract_exit_intent", post(set_contract_exit_intent))
        .route("/api/clear_contract_exit_intent", post(clear_contract_exit_intent))
        .route("/api/preview_contract_termination", post(preview_contract_termination))
        .route("/api/terminate_contract_now", post(terminate_contract_now))
        ...
        .route("/api/start_youth_scouting", post(start_youth_scouting))
        .route("/api/cancel_youth_scouting", post(cancel_youth_scouting))
        .route("/api/reassign_youth_scouting", post(reassign_youth_scouting))
